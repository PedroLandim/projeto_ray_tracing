...
sphere1 = Sphere(Vector3(-5, 0, -10), 3, Material(Vector3(1, 0.2, 0.2), reflection=0.8, refraction=1.1))
sphere2 = Sphere(Vector3(0, 0, -15), 2, Material(Vector3(0.2, 0.8, 0.2), reflection=0.8, refraction=1.1))
sphere3 = Sphere(Vector3(5, 0, -20), 3, Material(Vector3(0.2, 0.2, 1), reflection=0.8, refraction=1.1))
...
scene = Scene(camera, [sphere1, sphere2, sphere3, plane], [light1, light2, light3], Vector3(0.2, 0.2, 0.2), Vector3())


engine = EngineRender()
image = engine.render(scene, True)

with open("reflection20.ppm", "w") as img_file:
