...
triangle = Triangle(Vector3(-1, 3, -20), Vector3(-1, 0, -20), Vector3(1, 0, -20), Material(Vector3(1, 1, 0), reflection=0))
...
camera = Camera(800, 800, 50, Vector3(0, 1, 0), Vector3(4, 0, -40), Vector3(0, 0, 0)).transform([
    [1, 0, 0, 0],
    [0, 1, 0, 40],
    [0, 0, 1, 0],
    [0, 0, 0, 1]
...
with open("translação-camera.ppm", "w") as img_file:
