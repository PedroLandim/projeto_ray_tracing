...
sphere1 = Sphere(Vector3(-10, 0, -10), 3, Material(Vector3(1, 0.2, 0.2), reflection=0, refraction=1.9)).transform([
    [1, 0, 0, 7],
    [0, 1, 0, 0],
    [0, 0, 1, -5],
    [0, 0, 0, 1]
...
sphere3 = Sphere(Vector3(10, 0, -20), 3, Material(Vector3(0.2, 0.2, 1), reflection=0, refraction=1.9))

triangle = Triangle(Vector3(-1, 3, -20), Vector3(-1, 0, -20), Vector3(1, 0, -20), Material(Vector3(1, 1, 0), reflection=0)).transform([
    [1, 0, 0, 5],
    [0, 1, 0, 4],
    [0, 0, 1, -10],
    [0, 0, 0, 1]
...
camera = Camera(800, 600, 50, Vector3(0, 1, 0), Vector3(4, 0, -40), Vector3(0, 0, 0))
...
mesh = TriangleMesh(mesh_vertices, mesh_triangles, mesh_material).transform([
    [1, 0, 0, 0],
    [0, 1, 0, -3],
    [0, 0, 1, -20],
    [0, 0, 0, 1]
...
with open("translaçãoteste.ppm", "w") as img_file:
