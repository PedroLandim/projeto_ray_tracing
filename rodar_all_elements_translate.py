...
new_position = Vector3(4, 4, 10)
center_to_new = new_position - Vector3(0, 2, -5)  # Vetor do centro da esfera até o novo ponto
normal = center_to_new.crossProduct(Vector3(-1, -1, -1))  # Vetor perpendicular a ambos

sphere = Sphere(normal, 2, Material(Vector3(1, 0, 0)))
...
with open("raytest-all-elements-sphere-translated3.ppm", "w") as img_file:
